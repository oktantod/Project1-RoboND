...
def perception_step(Rover):
    ...
    x_center = Rover.img.shape[1] / 2
    y_center = Rover.img.shape[0]- bottom - dst_src
    
    source = np.float32([[ 12, 140], [ 300, 140], [ 119, 95], [ 198, 95]])
    destination = np.float32([[ x_center - dst_src, y_center + dst_src], 
